...
const src = path.join(
  ...
  "assets",
  "c__Users_jgree_AppData_Roaming_Cursor_User_workspaceStorage_3069cd118c90732aa7198774e2a10d9b_images_image-2881c079-d12c-47b3-ad9a-b0c7a8793454.png",
);
...
async function main() {
  ...
  // Flood-fill from corners through near-white only so the white cap stays.
  while (stack.length) {
    const [x, y] = stack.pop();
