import { PrismaClient, LessonType, UserRole, UserStatus } from "@prisma/client";
...
async function main() {
      ...
      modules: [
        {
          title: "Core content",
          lessons: [
            { slug: "l1", title: "System overview & components", type: "VIDEO" as LessonType, durationMinutes: 18, sortOrder: 0 },
            { slug: "l2", title: "Zone layout best practices", type: "MANUAL" as LessonType, sortOrder: 1 },
            { slug: "l3", title: "Backflow prevention", type: "VIDEO" as LessonType, durationMinutes: 22, sortOrder: 2 },
            { slug: "l4", title: "Fundamentals knowledge check", type: "EXAM" as LessonType, sortOrder: 3 },
          ],
        },
      ],
      progress: { demo: ["COMPLETED", "COMPLETED", "IN_PROGRESS", "NOT_STARTED"] as const },
      ...
      modules: [
        {
          ...
          lessons: [
            { slug: "s1", title: "Hazard identification", type: "VIDEO" as LessonType, durationMinutes: 15, sortOrder: 0 },
            { slug: "s2", title: "Safety manual (2025)", type: "MANUAL" as LessonType, sortOrder: 1 },
            { slug: "s3", title: "Annual safety exam", type: "EXAM" as LessonType, sortOrder: 2 },
          ],
        },
      ],
      ...
      modules: [
        {
          ...
          lessons: [
            { slug: "c1", title: "Brand voice & first impressions", type: "VIDEO" as LessonType, durationMinutes: 12, sortOrder: 0 },
            { slug: "c2", title: "Handling difficult conversations", type: "VIDEO" as LessonType, durationMinutes: 20, sortOrder: 1 },
          ],
        },
      ],
  ...
  const manuals = [
    { title: "Storm Sprinklers Field Operations Manual", category: "Operations", version: "3.2", pageCount: 48 },
    { title: "Equipment Maintenance Guide", category: "Maintenance", version: "1.8", pageCount: 32 },
    { title: "Safety & Incident Reporting Handbook", category: "Safety", version: "2025.1", pageCount: 24 },
  ];
      ...
      for (const [i, lesson] of mod.lessons.entries()) {
        const created = await prisma.lesson.create({
          data: {
            ...
            durationMinutes: "durationMinutes" in lesson ? lesson.durationMinutes : null,
          },
        });
        ...
        if (lesson.type === "EXAM") {
          ...
          await prisma.answerOption.createMany({
            data: [
              { questionId: q1.id, text: "Increase water pressure", isCorrect: false, sortOrder: 0 },
              { questionId: q1.id, text: "Prevent contaminated water from entering the supply", isCorrect: true, sortOrder: 1 },
              { questionId: q1.id, text: "Filter debris from sprinklers", isCorrect: false, sortOrder: 2 },
              { questionId: q1.id, text: "Schedule watering times", isCorrect: false, sortOrder: 3 },
            ],
          });
  ...
  console.log("Admin: admin@stormsprinklers.com / admin123!");
